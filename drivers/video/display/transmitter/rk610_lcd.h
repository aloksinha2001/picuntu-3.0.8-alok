...
#define LVDS_8BIT_3     0x02
#define LVDS_6BIT       0x03
...
enum{
    ...
    SCALE_PLL(148500000,    40500000,   24, 11, 8),
    SCALE_PLL(148500000,    40218750,   26, 12, 8),
    SCALE_PLL(148500000,    35062500,   17, 9, 8),
    SCALE_PLL(148500000,    81000000,   24, 11, 4),

    SCALE_PLL(74250000,     108000000,  32, 11,  2),
    SCALE_PLL(74250000,     99000000,   16, 3,  4),
    SCALE_PLL(74250000,     66000000,   32, 9,  4),
    SCALE_PLL(74250000,     60750000,   36, 11, 4),
    ...
    SCALE_PLL(74250000,    40500000,   48, 11, 8),
    SCALE_PLL(74250000,    40218750,   13, 6, 8),
    SCALE_PLL(74250000,    35062500,   34, 9, 8),
    SCALE_PLL(74250000,    95906250,   31, 6, 4),
    SCALE_PLL(74250000,     81000000,   48, 11,  4),
    ...
    SCALE_PLL(27000000,     81750000,   109, 9,  4),
    SCALE_PLL(27000000,     70312500,   125, 6,  8),
    SCALE_PLL(27000000,     40017857,   83, 7,  8),
    SCALE_PLL(27000000,     35156250,   125, 12,  8)
};
