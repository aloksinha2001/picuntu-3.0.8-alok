...
#define OUT_CLK	          73000000		// 1280x800x1.13x60(hz)
...
/* Other */
#define DCLK_POL		1		//sample falling, use 0 for sample rising
#define SWAP_RB		0
...
#define S_OUT_CLK		SCALE_RATE(148500000,74250000) //m=12 n=6 no=4
#define S_H_PW			55
#define S_H_BP			50
#define S_H_VD			1280
#define S_H_FP			100
...
//1920*1080*50
#define S1_OUT_CLK		SCALE_RATE(148500000,67500000)  //m=20 n=11 no=4 
#define S1_H_PW			90
#define S1_H_BP			90
#define S1_H_VD			1280
#define S1_H_FP			160
...
//1024*720*60
#define S2_OUT_CLK		SCALE_RATE(74250000,74250000)  //m=16 n=3 no=4
#define S2_H_PW			55
#define S2_H_BP			50
#define S2_H_VD			1280
#define S2_H_FP			100
...
#define S3_OUT_CLK		SCALE_RATE(74250000,67500000)   // m=40 n=11 no=4
#define S3_H_PW			90
#define S3_H_BP			90
#define S3_H_VD			1280
#define S3_H_FP			160
...
//720*576*50
#define S4_OUT_CLK		SCALE_RATE(27000000,63281250)  //m=125 n=6 no=8
#define S4_H_PW			10
#define S4_H_BP			10
#define S4_H_VD			1280
#define S4_H_FP		        155
