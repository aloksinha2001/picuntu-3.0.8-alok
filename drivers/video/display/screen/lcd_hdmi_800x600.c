...
#define S_OUT_CLK		SCALE_RATE(148500000,40500000) //m=24 n=11 no=8
#define S_H_PW			30
#define S_H_BP			16
#define S_H_VD			800
#define S_H_FP			234
...
/**************config pll***************
xin=74.250000
/           hdmi mode 1280*720*60       /
/*********best lcd config *******
    bestline=0.000000 
    vtotal=625 
    best_htotal=935 
    HZ=60.000000 
    clk=35.062500 m=34 n=9 no=8 
    fvst + VBP +VPW =25 
    fhst=0
config success 
/           hdmi mode 1280*720*50       /
/*********best lcd config *******
    bestline=0.000000 
    vtotal=625 
    best_htotal=1122 
...
*/
//1280*720*60
#define S2_OUT_CLK		SCALE_RATE(74250000,40500000)  //m=48 n=11 no=8
#define S2_H_PW			30
#define S2_H_BP			16
#define S2_H_VD			800
#define S2_H_FP			234
...
#define S3_OUT_CLK		SCALE_RATE(74250000,35062500)   // m=34 n=9 no=8 
#define S3_H_PW			30
#define S3_H_BP			16
#define S3_H_VD			800
#define S3_H_FP			276
...
/**************config pll***************
xin=27.000000
/           hdmi mode 720*576*50        /
/*********best lcd config *******
    bestline=0.000000 
    vtotal=651 
    best_htotal=1080 
    HZ=50.003200 
    clk=35.156250 m=125 n=12 no=8 
    fvst + VBP +VPW =51 
    fhst=45
config success 
/           hdmi mode 720*480*60        /
/*********best lcd config *******
    bestline=0.000000 
    vtotal=655 
    best_htotal=1001 
    HZ=60.054449 
    clk=39.375000 m=35 n=3 no=8 
    fvst + VBP +VPW =51 
    fhst=250
*/
...
#define S4_V_ST			34
//720*480*60
#define S5_OUT_CLK		SCALE_RATE(27000000,45000000)  //m=40 n=3 no=8 
#define S5_H_PW			30
#define S5_H_BP			16
#define S5_H_VD			800
#define S5_H_FP			288
