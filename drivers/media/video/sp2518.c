...
#define  SP2518_P0_0xf9  0x6c //0x74///0x80//74
#define  SP2518_P0_0xfa  0x62 //0x6a///0x74//6a

//HEQ
#define  SP2518_P0_0xdd  0x70	//0x80 modify by sp_yjp,20120814  0x7c
#define  SP2518_P0_0xde  0x90	//0x90 modify by sp_yjp,20120815  0x8a xg test
...
static struct reginfo sensor_init_data[] =
{
	...
	#if 1  
	//xg add 2012-10-13
	//SP2518 UXGA 24MEclk 2±¶Æµ 1·ÖÆµ 50Hz fix 9fps
 	//ae setting
	  {0xfd,0x00},
	  {0x03,0x02},
	  {0x04,0xbe},
	...
	{0xda,0x64},	//0x77 modify by sp_yjp,20120814
	{0xdb,0x64},	//0x77 modify by sp_yjp,20120814
	//uv_dif
	{0xfd,0x00},
	{0xf3,0x03},
	{0xb0,0x00},
	...
	{0xfd,0x00},
	{0x31,0x10},
	{0x32,0x0d}, //0x0d  //zouyu 20121022     0x15    //xg 20121121 0x0d
	{0x33,0xcf},//ef
	{0x34,0x7f},//3f
	
	{0x35,0x40},//3        
	
	//{0x1b,0x02},   //modifed by zouyu 121124
	{0xe7,0x03},
	{0xe7,0x00},
...
static  struct reginfo sensor_SceneNight[] =
{
	...
	{0xda , 0x00},
#else//xg add 2012-10-13
	//SP2518 UXGA 24MEclk 2±¶Æµ 1·ÖÆµ 50Hz fix 6fps
	//ae setting
	  {0xfd , 0x00},
	  {0x03 , 0x01},
	  {0x04 , 0xd4},
